...
if($exe2->num_rows > 0){
	$updatesql="UPDATE `RepairingStatus` SET `DelBoyId` = '$empId', `PickDropStatus`='$status', `DelBoyStartTime`='$datetime' WHERE `CaseId` = '$caseId'";
	$exe1 = $db1->query($updatesql);
	echo "case assigned to delivery boy";
