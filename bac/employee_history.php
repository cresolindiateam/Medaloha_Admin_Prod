...
if($_SESSION['username']==""){
  ...
  $sqlEmp = "SELECT First_Name,Mobile_Number,UserType FROM `UserProfile` WHERE `Id`=$empId";
  ...
  $sql = "SELECT CaseId,UserId,EmployeeId,TotalAmount,DeliveryDate,RepairDetail,EmpStartTime,EmpEndTime,CancelReason,WorkStatus,PendingReason,EmpAssignTime FROM `RepairingStatus` WHERE `EmployeeId`=$empId ORDER BY `Created_At` DESC";
  $exe = $db->query($sql);
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="row">
              <div class="col-md-1"><i class="fa fa-user"></i></div>
               <div class="col-md-9">
               <div class="personal-info-label">Employee Name</div>
          ...
          <div class="col-md-4">
            <div class="row">
              <div class="col-md-1"><i class="fa fa-user"></i></div>
               <div class="col-md-9">
               <div class="personal-info-label">Emp Type</div>
               <div class="divider"></div>
               <div class="personal-info-answer"><span id="email"><?php echo $userType;?></span></div>
               </div>
            </div>
          </div>
        </div>
...
foreach ($data as $key => $item){
        ...
        $empAssignTime = $item['EmpAssignTime'];
